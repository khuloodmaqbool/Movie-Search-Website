...
export const GetMovie = () => {
    ...
    return (
        <>
        <h1 className="text-5xl font-black text-center bg-orange_color py-5 text-black" style={{fontFamily: "AnyBody"}} >Search Movie Website</h1>
          <div className="flex flex-col justify-center items-center w-fit mx-auto">
          <Input className="lg:w-96 md:w-96 w-2/8 py-6 px-4 text-lg mt-12" placeholder="Type Movie Name" type="text" value={searchMovie} onChange={(event: any) => setSearchMovie(event.target.value)} />
          <Button variant="outline" className="text-lg w-fit my-8 text-white rounded-lg py-6 px-8 bg-orange_color" onClick={handleMovieBtn} >Search</Button>
          </div>


            {
                loading ? <div className="loader"></div> : error ? <p></p> : apiData &&
                    <section className="text-gray-600 body-font overflow-hidden">
                        <div className="container px-5 py-24 mx-auto">
                            <div className="lg:w-4/5 mx-auto flex flex-wrap items-center">
                                ...
                                <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-auto object-cover object-top rounded" src={apiData.Poster} />
                            </div>
                        </div>
                    </section>
